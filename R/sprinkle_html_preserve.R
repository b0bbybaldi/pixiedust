...
#'  \item Cast an error if \code{html_preserve} is not a logical object.
#'  \item Cast an error if \code{html_preserve} has length greater than 1.
#' }
#' 
#' @export
...
sprinkle_html_preserve_index_assert <- function(html_preserve, coll)
{
...
sprinkle_html_preserve_index <- function(x, html_preserve)
{
